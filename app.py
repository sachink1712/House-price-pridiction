...
pickle_in = open('/Users/sachinkumar/Documents/MSc.BS/Sem-1/SET-1/BHP/model/bangalore_house_price_model.pickle','rb')
regressor = pickle.load(pickle_in)

with open('/Users/sachinkumar/Documents/MSc.BS/Sem-1/SET-1/BHP/model/columns.json','r') as f:
    data = json.load(f)
